...
class verletPhysicsEngine{
	...
	updatePoints(deltatime = Caldro.time.deltatime){
...
var pointStartEvent = function (pointer, pointerType) { };
var pointMoveEvent = function (pointer, pointerType) { };
var pointEndEvent = function (pointer, pointerType) { };
/* function clickEvent(){}
...
class button {
	constructor(x = 0, y = 0, width = 80, height = 30, text = 'Button', color = 'Grey', strokeColor = 'white') {
		...
		this.show = function () {
			if (this.visible == true) {
				if (this.active == false) {
					...
					glow(this.glow, this.strokeColor);
				}
				this.render();
				this.drawing();
				this.callback();
		...
		this.dolater = function (delay, func) {
